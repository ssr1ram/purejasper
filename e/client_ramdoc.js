  ...
  module.exports = {
    start: function(cb) {
      ...
      this.client = new Dropbox.Client({
        key: 'CeVBCDIaTYA=|uH3TMjNKLoaYgEexJ2fsAUbWALs2w5iJkRyK2gABdg==',
        sandbox: true
      });
    ...
    "rams": [
      {
        "name": "Home",
        "slug": "home",
        "contents": "<h2>Ramdoc Basics</h2>This is a RamDoc. Ram's are Richly Annotated&nbsp;Messages that link to each other and contain easily editable html.<br><ul><li>To Edit this Ram:&nbsp;Click edit on the top right of this message box</li><li>To Create a new Ram:&nbsp;Type `[[RamTitle]] (without the backtick)&nbsp;</li><ul><li>This will create a special link which when clicked will open a new Ram tab</li><li>Something like this:&nbsp;<a class=\"ramlink\" href=\"#ram/about\" data-ram=\"about\" title=\"Link: #ram/about\">About</a></li></ul></ul>Click on the FileName to bring up the File Manager, which allows you to create new documents etc.<br>"
      }, {
        "name": "About",
        "slug": "about",
        "contents": "I am empty<br><br>edit me or go back <a class=\"ramlink\" href=\"#ram/home\" data-ram=\"home\">Home</a>&nbsp;"
      }
    ]
  };
  ...
  module.exports = Backbone.View.extend({
    ...
    docopyto: function(ev) {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        f = _ref[_i];
        if (tofile.replace('.ram', '') === f.replace('.ram', '')) fxists = true;
      }
      if (fxists) {
        $(".errspot", this.el).html("File exists");
        return;
      }
      if (tofile.indexOf('.ram') === -1) tofile = tofile + ".ram";
    ...
    donew: function(ev) {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        f = _ref[_i];
        if (nufile.replace('.ram', '') === f.replace('.ram', '')) fxists = true;
      }
      if (fxists) {
        $(".errspot", this.el).html("File exists");
        return;
      }
      if (nufile.indexOf('.ram') === -1) nufile = nufile + ".ram";
...
require.define("/wiki_link.coffee", function (require, module, exports, __dirname, __filename) {
(function() {
...
require.define("/app.coffee", function (require, module, exports, __dirname, __filename) {
  ...
  AppRouter = Backbone.Router.extend({
    ...
    home: function(doc) {
      var mainV;
      if (!doc) doc = 'ramone.ram';
      if (doc.indexOf('.ram') === -1) doc = doc + '.ram';
      return mainV = new v({
        doc: doc
      });
    },
